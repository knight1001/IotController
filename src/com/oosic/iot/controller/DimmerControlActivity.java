...
public class DimmerControlActivity extends IotBaseActivity implements
      OnClickListener {
   ...
   private void analyzeResult(DimmerDataListener listener,
   ...
   class DimmerDataListener extends DeviceDataListener {
      ...
      public DimmerDataListener(DeviceItem device) {
         super(device);
      }
